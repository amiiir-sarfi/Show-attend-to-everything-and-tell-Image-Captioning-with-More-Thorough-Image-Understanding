...
def visualize(original_image, target_class, pretrained_model, target_layer=12, save_img=False, file_name='gradcam.png'):
    grad_cam = GradCam(pretrained_model, target_layer=target_layer)
    # Generate cam mask
    cam,target_class = grad_cam.generate_cam(original_image, target_class)
    # Save mask
